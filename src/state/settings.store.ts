...
import type { UserSettings, UserSettingsUpdateRequest, WeekStartsOn } from "@/types/settings.types";
        ...
        (set, get) => ({
            ...
            load: async () => {
                ...
                try {
                    ...
                    const msg =
                        typeof e?.message === "string" ? e.message : "Failed to load settings (using local defaults)";
                ...
                try {
                    ...
                    const msg =
                        typeof e?.message === "string"
                            ? e.message
                            : "Backend settings not available yet. Saved locally.";
