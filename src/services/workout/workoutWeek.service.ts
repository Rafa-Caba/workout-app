...
import type { WeekKey, WeekViewResponse, BuildOpts } from "@/types/workoutDay.types";
 ...
 * - we want plannedRoutine + training presence for tabs
 * - keep it light (no rollups/totals/types/raw by default)
 */
